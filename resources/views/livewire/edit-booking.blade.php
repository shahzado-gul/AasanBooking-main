        ...
        <div class="row mt-3">
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    {!! Form::number('reservation', null, ["wire:model='reservation'", 'class' => 'form-control', 'id' => 'booking', 'placeholder' => 'MySeat']) !!}
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    {!! Form::label('rate', 'Rate',['class'=>'mb-1']) !!}
                    {!! Form::number('rate', null, ["wire:model='rate'", 'min'=>'1','class' => 'form-control', 'id' => 'rate', 'placeholder' => 'Rate']) !!}
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    {!! Form::select('status',$statuses, $status, ["wire:model='status'", 'class' => 'form-control', 'placeholder' => 'Select Status']) !!}
                </div>
            </div>
        </div>
        <div class="row mt-3">
