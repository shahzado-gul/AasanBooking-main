...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{Route('user.booking.create')}}" class="btn btn-success btn-sm"><i class="link-icon" data-feather="plus"></i> Add</a>
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{($booking->status)?'approve':'pending'}}</td>
                                <td>
                                    <a href="{{route('user.booking.show',$booking->id)}}" class="btn btn-sm btn-warning"><i class="fa fa-print" aria-hidden="true">Print</i></a>
