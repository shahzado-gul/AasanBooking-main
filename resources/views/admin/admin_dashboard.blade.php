...
<head>
    ...
    <title>Admin Panel - Aasanbooking</title>
    ...
    <style>
        /* .form-control
    {
        border: solid rgb(203, 203, 203) 1px!important;
    }
    .page-content
    {
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a href="{{ Route('admin.vehicle.index') }}" class="nav-link">
                            <i class="link-icon"></i>
                            <span class="link-title">Vehicle</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ Route('admin.root.index') }}" class="nav-link">
                            <i class="link-icon"></i>
                            <span class="link-title">Root</span>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu p-0" aria-labelledby="notificationDropdown">
                                ...
                                <div class="p-1"><a href="javascript:;"
